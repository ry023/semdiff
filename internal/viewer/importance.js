...
var importanceData=window.semdiffImportance?Promise.resolve(window.semdiffImportance):fetch('/importance.json').then(function(response){return response.json()});
importanceData.then(function(data){
